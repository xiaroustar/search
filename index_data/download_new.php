...
<div class="xiarou-ziyuansou" data-v-3f764ca5="">
    <div class="yp-search-rank-header xiarou-ziyuansou" data-v-3f764ca5="">
        <ul class="yp-detail-main-breadcrumb xiarou-ziyuansou" data-v-3f764ca5="">
            ...
            <li class="yp-detail-main-breadcrumb-item xiarou-ziyuansou" data-v-3f764ca5="">
                <a class="xiarou-ziyuansou" href="/download_top" target="_blank" data-v-3f764ca5="">
                    下载榜单
                </a>
                <svg width="14" height="14" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg"
                class="breadcrumb-item-icon xiarou-ziyuansou" data-v-3f764ca5="">
    ...
    data-v-3f764ca5="" data-v-edfa7348="">
        <tbody class="xiarou-ziyuansou result-container-download_top" data-v-edfa7348=""><div id="loading_download_top" style="display: none;">加载中...请耐心等候！若长时间未加载数据请刷新页面！</div></tbody>
    </table>
</div>
...
document.addEventListener('DOMContentLoaded', function () {
    loading_data();
                const fetchData = async () => {
                    const apiUrl = '<?php echo $dataurl_api;?>/api/data_api/index_data_download_top_api/';
                    const resultContainer = document.querySelector('.result-container-download_top');
                    resultContainer.innerHTML = ''; // 清空内容
            
                    // 显示加载动画
                    const loading = document.getElementById('loading_download_top');
